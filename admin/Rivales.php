...
<div class="wrapper">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">				
				...
				include('ProcesosRivales.php');

				?>
            <div class="card">
              <div class="card-header">
				<button type='submit' name='FormActualizar' title='CARGAR CAMPEONATOS' class='btn btn-success' data-toggle='modal' data-target='#ModalCargarRivales'><img src="img/Rivales.png" style="width:30px; color:#000;" />CARGAR NUEVA RIVAL</button>
              </div>
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
												...
												$sqlSelect = "SELECT * FROM rival";
												$result = mysqli_query($conn, $sqlSelect);
												while ($row = mysqli_fetch_array($result)) { 												
													
													echo "<tr class='odd'>";
													echo "<td><button type='button' class='btn btn-outline-warning' data-toggle='modal' data-target='#ModalModificarRival".$row['id_rival']."'><i class='icon fas fa-edit' data-toggle='tooltip' data-placement='top' title='EDITAR INFORMACIÓN'></i></button></td>";
													...
													<!-- INICIO - MODAL MODIFICAR CATEGORIA -->
														<div class="modal fade" id="ModalModificarRival<?php echo $row['id_rival']; ?>">
															<div class="modal-dialog">
																<div class="modal-content">
																	<form action="Rivales.php" enctype="multipart/form-data" method="POST">
																	...
																	<input type="hidden" name="IdRival" class="form-control" value="<?php echo $row['id_rival']; ?>">																	
																	<button type="button" data-dismiss="modal" class="btn btn-primary">Cerrar sin guardar</button> 
																	<input name="ModificarRival" type="submit" value="MODIFICAR CATEGORIA" class="btn btn-success">
																	</div>
																	<!-- FIN - BOTONES MODAL -->
																	</form>
																</div>
  ...
  <!-- FIN - PIE	-->
	...
	<!-- INICIO - MODAL MODIFICAR CATEGORIA -->
		<div class="modal fade" id="ModalCargarRivales">
			<div class="modal-dialog">
				<div class="modal-content">
					<form action="Rivales.php" enctype="multipart/form-data" method="POST">
					<!-- INICIO - ENCABEZADO MODAL -->
					<div class="modal-header">
					<h4 class="modal-title">CARGAR RIVAL</h4>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
					</div>
					...
					<div class="modal-footer justify-content-between">
					<button type="button" data-dismiss="modal" class="btn btn-primary">Cerrar sin guardar</button> 
					<input name="CargarRival" type="submit" value="CARGAR DIVISION" class="btn btn-success">
					</div>
					<!-- FIN - BOTONES MODAL -->
					</form>
				</div>
